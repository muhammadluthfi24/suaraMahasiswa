...
<!-- ------------------------------------------------------------------------------------------------------------------------------------ -->
        ...
        <div id="user_edit<?php echo $r['id_petugas'] ?>" class="modal">
          <div class="modal-content">
			...
			<?php 
include "../conn/koneksi.php"; // Pastikan path ke file koneksi.php sesuai dengan struktur proyek Anda

if(isset($_POST['Update'])){
    $id_petugas = $_POST['id_petugas']; // Pastikan $_POST['id_petugas'] tersedia
    ...
    $query = "UPDATE petugas SET nama_petugas='$nama', username='$username', telp_petugas='$telp', level='$level' WHERE id_petugas='$id_petugas'";
    ...
    if($update){
        ...
        echo "Error updating record: " . mysqli_error($koneksi); // Tampilkan pesan error jika query gagal
    }
}
?>
          ...
          <div class="modal-content">
			...
			<?php 
				if(isset($_POST['input'])){
					...
					// Query untuk memasukkan data baru ke dalam tabel
					$query = "INSERT INTO petugas (nama_petugas, username, password, telp_petugas, level) 
					...
					if($result){
						...
						echo "Error: " . mysqli_error($koneksi); // Tampilkan pesan error jika query gagal
					}
				}
			?>
